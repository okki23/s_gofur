...
class Anggota extends Parent_controller {
  ...
  var $tablename = 't_anggota';
    ...
    public function index() {
        ...
        $save = $this->db->query("insert into t_anggota (id,nama_barang,barcode,jumlah) values (null,'$datapos[nama_barang]','$datapos[barcode]','$datapos[jumlah]') ");
        ...
        public function delete(){
          ...
          $del = $this->db->query("delete from t_anggota where id = '$idpost' ");
